...
covid_primary_care_case = codelist_from_csv(
    "codelists/opensafely-covid-identification-in-primary-care-covid-positive-test.csv",
    system="ctv3", 
    column="CTV3ID",
)

covid_primary_care_suspect_case = codelist_from_csv(
    "codelists/opensafely-covid-identification-in-primary-care-covid-clinical-code.csv",
    system="ctv3", 
    column="CTV3ID",
)
